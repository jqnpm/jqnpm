...
function testJqExecution () {
	...
	assertTrue "Package is installed" "[[ -d 'local-project/.jq/packages/anotheruser/pack3/' ]]"
	...
	assertTrue "Package is installed" "[[ -d 'local-project/.jq/packages/someuser/pack4/' ]]"
	assertTrue "Package is installed" "[[ -d 'local-project/.jq/packages/someuser/pack2/.jq/packages/anotheruser/pack3/' ]]"
	assertEquals "Result" 'abc123def456ghi789|456|123' "$result"
}
